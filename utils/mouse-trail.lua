...
mouse_trail.particles = {}
mouse_trail.amount = 1
mouse_trail.life_span = 15

mouse_trail.add = function (self, x, y)
...
mouse_trail.update = function (self, delta_time)
...
mouse_trail.draw = function (self)
...
mouse_trail.modify_amount = function (self, number)
  number = number or 1
